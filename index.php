...
<body class="theme-red">
    ...
    <div class="vg-page page-home" id="home" style="background-image: url(./assets/img/bg_image_1.jpg)">
        ...
        <div class="caption-header text-center wow zoomInDown">
            ...
            <h1 class="fw-light mb-4">I'm <b class="fg-theme">Rizki</b> Pratama</h1>
        ...
        <div class="container py-5">
            <div class="row">
                ...
                <div class="col-lg-6 offset-lg-1 wow fadeInRight">
                    <h1 class="fw-light">Rizki Pratama</h1>
                    <h5 class="fg-theme mb-3">Fullstack</h5>
                    ...
                    <ul class="theme-list">
                        <li><b>From:</b> Lhokseumawe, Aceh</li>
                        <li><b>Lives In:</b> Aceh, Indonesia</li>
                        <li><b>Age:</b> 32</li>
            ...
            <div class="row">
                <div class="col-lg-4 py-3">
                    <div class="footer-info">
                        ...
                        <hr class="divider">
                        <p class="fs-large fg-white">Jl. Satelit, Hagu Teungoh, Banda Sakti, Lhokseumawe - ACEH</p>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-lg-3 py-3">
                    <div class="float-lg-right">
                        ...
                        <hr class="divider">
                        <ul class="list-unstyled">
                            <li>rici.delphy@gmail.com</li>
                            <li>+62 852 7766 3642</li>
                        </ul>
                    </div>
                </div>
            </div>
